...
import 'package:to_do_c10_monday/auth/login/login_view_model.dart';
...
class _LoginTabState extends BaseView<LoginTab, LoginViewModel>
  ...
  void initState() {
    ...
    super.initState();
    viewModel.connector = this; //connects to the connector
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => viewModel, //creates the object
      child: Padding(
